            ...
            <div class="box-content">
              <div class="box-content-text">
                ...
                <div class="card-content-form">
                  {{Form::open(array('route' => ['update_post', $post->id], 'method' => 'POST', 'files' => 'true'))}}
                    {{ csrf_field() }}
                    <div class="field">
                    ...
                    <div class="field">
                      ...
                      <p class="control">
                        <textarea class="textarea" placeholder="Content" name="content" required>{!!$post->content!!}</textarea>
                      </p>
                    </div>
                    <div class="field">
